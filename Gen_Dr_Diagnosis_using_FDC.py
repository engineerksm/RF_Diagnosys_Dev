...
for featureIdx in range(0, num_of_feature):
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(normalData, label='Normal', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
            plt.plot(normalData, label='Normal')
            plt.plot(FdcDataUpper, label='UpperLv', color='red', markersize=1, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower, label='LowerLv', color='red', markersize=1, linewidth=1, alpha=0.7, linestyle='dashed')
    # plt.show()
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper1 = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower1 = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(abnormalData1, label='Normal1', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper1, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower1, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper2 = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower2 = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(abnormalData2, label='normal2', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper2, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower2, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper3 = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower3 = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(abnormalData3, label='normal3', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper3, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower3, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper4 = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower4 = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(abnormalData4, label='normal4', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper4, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower4, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
    ...
    for fileName in file_list_csv[idx]:
        ...
        FdcDataUpper5 = loadData[idx_col[featureIdx]] * 1.1
        FdcDataLower5 = loadData[idx_col[featureIdx]] * 0.9

        if fileName == '1. ReferenceData.csv':
            plt.plot(abnormalData5, label='normal5', color='green', markersize=3, linewidth=2, alpha=0.7)
            plt.plot(FdcDataUpper5, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
            plt.plot(FdcDataLower5, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7, linestyle='dashed')
        else:
    ...
    for idx in range(1, len(path_List)):
        for fileName in file_list_csv[idx]:
            ...
            FdcAllDataUpper = loadData[idx_col[featureIdx]] * 1.1
            FdcAllDataLower = loadData[idx_col[featureIdx]] * 0.9

            if fileName == '1. ReferenceData.csv':
                plt.plot(AllData, label='normalAllData', color='green', markersize=3, linewidth=2, alpha=0.7)
                plt.plot(FdcAllDataUpper, label='UpperLv', color='red', markersize=2, linewidth=1, alpha=0.7,
                         linestyle='dashed')
                plt.plot(FdcAllDataLower, label='LowerLv', color='red', markersize=2, linewidth=1, alpha=0.7,
                         linestyle='dashed')
            else:
